...
import com.aking.Job.portal.entity.*;
import com.aking.Job.portal.repository.JobPostActivityRepository;
...
public class JobPostActivityService {
    ...
    public List<JobPostActivity> search(String job, String location, List<String> type, List<String> remote, LocalDate searchDate) {
        return Objects.isNull(searchDate)?jobPostActivityRepository.searchWithoutDate(job,remote,type):
